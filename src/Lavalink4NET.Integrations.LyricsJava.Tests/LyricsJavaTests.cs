...
public sealed class LyricsJavaTests
{
    ...
    public async Task TestGetGeniusLyricsAsync()
    {
        ...
        var art = Assert.Single(lyrics.Track.AlbumArt);
        Assert.Null(art.Width);
        Assert.Null(art.Height);
        Assert.Equal("https://images.genius.com/88634fdafc60d4ff1e76944436c34a19.901x901x1.png", art.Uri.ToString());
    }

    [Fact]
    public async Task TestGetGeniusLyricsWithUnknownDimensionsAsync()
    {
        // Arrange
        await using var httpClientFactory = new HttpClientFactory();
    ...
    [Fact]
    public async Task TestGetGeniusLyricsWithKnownDimensionsAsync()
    {
        // Arrange
        await using var httpClientFactory = new HttpClientFactory();
        ...
        var art = Assert.Single(lyrics.Track.AlbumArt);
        Assert.Equal(480, art.Width);
        Assert.Equal(320, art.Height);
        Assert.Equal("https://images.genius.com/88634fdafc60d4ff1e76944436c34a19.901x901x1.png", art.Uri.ToString());
    }
